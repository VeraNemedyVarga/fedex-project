        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'App' },
                    _react2.default.createElement(_reactRouterDom.Route, { path: '/organization', component: _dashboard2.default }),
                    _react2.default.createElement(
                        'h1',
                        null,
                        'Hello world'
...
var Dashboard = exports.Dashboard = function (_React$Component) {
    ...
    function Dashboard(props) {
        ...
        ajax.loadData('/organization/' + window.sessionStorage.organizationID).then(function (data) {
            _this.setState({
                organisation: data
            });
        });

        ajax.loadData('/allprojects').then(function (data) {
            _this.setState({
                projects: data
            });
        });
...
var Ajax = function () {
    ...
    _createClass(Ajax, [{
        key: 'postData',
        value: function postData(endpoint, dataToSend) {
            var _this = this;

            return new Promise(function (resolve, reject) {
                fetch(_this.root + endpoint, {
                    method: 'POST',
        ...
        key: 'loadData',
        value: function loadData(endpoint) {
            var _this2 = this;

            return new Promise(function (resolve, reject) {
                fetch(_this2.root + endpoint, {
                    method: 'GET',
        ...
        key: 'putData',
        value: function putData(endpoint, dataToSend) {
            var _this3 = this;

            return new Promise(function (resolve, reject) {
                fetch(_this3.root + endpoint, {
                    method: 'PUT',
                    headers: _this3.putHeaders,
                    body: JSON.stringify(dataToSend)
                }).then(function (res) {
                    res.json().then(function (data) {
                        resolve(data);
